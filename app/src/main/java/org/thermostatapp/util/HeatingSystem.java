...
public class HeatingSystem {
    ...
    public static String BASE_ADDRESS = "http://wwwis.win.tue.nl/2id40-ws/44";
    public static String WEEK_PROGRAM_ADDRESS = "http://wwwis.win.tue.nl/2id40-ws/44/WeekProgram";
